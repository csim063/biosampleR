...
Browse the documentation to see if you can find a solution. Still stuck? Open an [issue on GitHub](https://github.com/csim063/biosampleR/issues) on GitHub. We'll try to do our best to address it, as questions often lead to better documentation or the discovery of bugs.

Want to ask a question in private? Contact the package maintainer by [simpkinscraig063\<at\>gmail.com](mailto:simpkinscraig063@gmail.com).
...
Take a look at the documentation and [issue on GitHub](https://github.com/csim063/biosampleR/issues) list to see if it isn't included or suggested yet. If not, please open a new issue!
...
Report it as an [issue on GitHub](https://github.com/csim063/biosampleR/issues) so we can fix it. A good bug report makes it easier for us to do so, so please include:
...
1. Fork [the repo](https://github.com/csim063/biosampleR) and clone it to your computer. To learn more about this process, see [this guide](https://guides.github.com/activities/forking/). Don't forget to pull all new changes before starting to work!
